...
mod material_adobe_materials_clearcoat_tint {
    use serde::{Serialize, Deserialize};
    use serde_json::{Map, Value};
    #[derive(Serialize, Deserialize, Debug)]
    ///glTF extension that defines the colour tint of the clearcoat.
    pub struct MaterialAdobeMaterialsClearcoatTint {
        #[serde(default)]
    ...
    impl crate::GltfExtension for MaterialAdobeMaterialsClearcoatTint {
        fn extension_name() -> &'static str {
            "ADOBE_materials_clearcoat_tint"
        }
    }
    impl crate::GltfObject for MaterialAdobeMaterialsClearcoatTint {
        fn extensions(&self) -> &Option<Map<String, Value>> {
            &self.extensions
        }
    }
}
pub use material_adobe_materials_clearcoat_tint::MaterialAdobeMaterialsClearcoatTint;
