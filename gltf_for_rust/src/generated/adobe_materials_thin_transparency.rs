...
mod gltf_adobe_materials_thin_transparency {
    ...
    impl crate::GltfExtension for GltfAdobeMaterialsThinTransparency {
        fn extension_name() -> &'static str {
            "ADOBE_materials_thin_transparency"
        }
    }
    impl crate::GltfObject for GltfAdobeMaterialsThinTransparency {
        fn extensions(&self) -> &Option<Map<String, Value>> {
            &self.extensions
        }
    }
}
pub use gltf_adobe_materials_thin_transparency::GltfAdobeMaterialsThinTransparency;
