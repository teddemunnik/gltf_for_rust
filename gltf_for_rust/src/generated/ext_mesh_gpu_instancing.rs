...
mod gltf_ext_mesh_gpu_instancing {
    ...
    impl crate::GltfExtension for GltfExtMeshGpuInstancing {
        fn extension_name() -> &'static str {
            "EXT_mesh_gpu_instancing"
        }
    }
    impl crate::GltfObject for GltfExtMeshGpuInstancing {
        fn extensions(&self) -> &Option<Map<String, Value>> {
            &self.extensions
        }
    }
}
pub use gltf_ext_mesh_gpu_instancing::GltfExtMeshGpuInstancing;
