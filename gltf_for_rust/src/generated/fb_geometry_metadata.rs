...
mod scene_fb_geometry_metadata {
    use serde::{Serialize, Deserialize};
    use serde_json::{Map, Value};
    #[derive(Serialize, Deserialize, Debug)]
    pub struct SceneFbGeometryMetadata {
        #[serde(default)]
        ///JSON object with extension-specific objects.
        pub extensions: Option<Map<String, Value>>,
        #[serde(default)]
        ...
        pub scene_bounds: Option<crate::generated::fb_geometry_metadata::SceneBounds>,
        #[serde(rename = "vertexCount")]
        #[serde(default)]
        ///The number of distinct vertices recursively contained in this scene.
        pub vertex_count: Option<f64>,
    }
    impl crate::GltfExtension for SceneFbGeometryMetadata {
        fn extension_name() -> &'static str {
            "FB_geometry_metadata"
        }
    }
    impl crate::GltfObject for SceneFbGeometryMetadata {
        fn extensions(&self) -> &Option<Map<String, Value>> {
            &self.extensions
        }
    }
}
pub use scene_fb_geometry_metadata::SceneFbGeometryMetadata;
