...
mod material_khr_materials_specular {
    ...
    impl crate::GltfExtension for MaterialKhrMaterialsSpecular {
        fn extension_name() -> &'static str {
            "KHR_materials_specular"
        }
    }
    impl crate::GltfObject for MaterialKhrMaterialsSpecular {
        fn extensions(&self) -> &Option<Map<String, Value>> {
            &self.extensions
        }
    }
}
pub use material_khr_materials_specular::MaterialKhrMaterialsSpecular;
